...
import useCreate from "../../../../actions/template2/work_showcase/useCreate";
import useEdit from "../../../../actions/template2/work_showcase/useEdit";
import useDelete from "../../../../actions/template2/work_showcase/useDelete";
...
const Actions = ({ switchMode, data }) => {
  ...
  if (isMode === "Create") {
    formTitle = "Create Template 2 - Work Showcase";
  } else if (isMode === "Edit") {
    formTitle = "Edit Template 2 - Work Showcase";
  } else {
    formTitle = "";
  }
    ...
    <>
      {isMode === "Create" && (
        ...
        >
          ...
          <Hidden only="xs">&nbsp;Add Work Showcase</Hidden>
        </Button>
      )}
