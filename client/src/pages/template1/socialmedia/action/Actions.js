...
import useCreate from "../../../../actions/template1/socialmedia/useCreate";
import useEdit from "../../../../actions/template1/socialmedia/useEdit";
import useDelete from "../../../../actions/template1/socialmedia/useDelete";
...
const Actions = ({ switchMode, data }) => {
  ...
  if (isMode === "Create") {
    formTitle = "Create Template 1 - Social Media";
  } else if (isMode === "Edit") {
    formTitle = "Edit Template 1 - Social Media";
  } else {
    formTitle = "";
  }
